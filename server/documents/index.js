module.exports = (data) => {
    ...
    <html>
        <head>
            ...
            <base href="C:/Users/RBK/Desktop/Work/upwork/trademarks/server">
                ...
                <div class="content-container">
                    ...
                    <div class="flex-container">
                        <div class="form-container">
                            ...
                            <p class="data-text">Data goes here</p>
                            ...
                            <br>
                            <!-- <input name="communication" type="checkbox" id="checkbox-input"/> -->
                            <img src="./checked-checkbox.svg" width="12px" height="12px" alt="">
                            ...
                            <div class="mark-container">
                                <div class="flex-container">
                                    <div class="brand-right-section">
                                        ...
                                        <img src="./checked-checkbox.svg" width="12px" height="12px" alt="">
                                        <label for="communication" class="paragraph-text">
                                            <b>Marque tridimensionnelle</b>
                                        </label><br>
            
                                        <img src="./checked-checkbox.svg" width="12px" height="12px" alt="">
                                        <label for="communication" class="paragraph-text">
                                            <b>Marque acoustique</b>
                                        </label><br>
            
                                        <img src="./checked-checkbox.svg" width="12px" height="12px" alt="">
                                        <label for="communication" class="paragraph-text">
                                            <b>Marque avec revendication de couleur</b>
                                        </label><br>
            
                                        <img src="./checked-checkbox.svg" width="12px" height="12px" alt="">
                                        <label for="communication" class="paragraph-text">
                                            <b>Marque de couleur (abstraite)</b>
                                        </label><br>
            
                                        <img src="./checked-checkbox.svg" width="12px" height="12px" alt="">
                                        <label for="communication" class="paragraph-text">
                                            <input type="text" placeholder="Data goes here"> 
                                        </label>
                                    </div>
